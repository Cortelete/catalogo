...
*Meus Dados:*
*Nome:* ${formData.name}
*Data Preferencial:* ${new Date(formData.preferredDate + 'T00:00:00').toLocaleDateString('pt-BR')}
    ...
    switch(step) {
      ...
      case 2: // Observations
       ...
       case 4: // Confirmation
        ...
        const formattedDate = formData.preferredDate ? new Date(formData.preferredDate + 'T00:00:00').toLocaleDateString('pt-BR') : 'Não informada';
        return (
          <div className="text-center">
            ...
            <div className="text-left bg-gray-800/50 p-4 rounded-lg my-4 text-amber-100/90 text-sm space-y-2">
              ...
              <p><strong>Data/Hora:</strong> {formattedDate} às {formData.preferredTime}</p>
